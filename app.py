...
# =====================================================
label_info = {
    "Penanaman": { "bg": "#D1FAE5", "text": "#065F46"}, # Hijau
    "Pemupukan": {"bg": "#FFEDD5", "text": "#9A3412"}, # Oranye
    "Penyiraman": {"bg": "#DBEAFE", "text": "#1E40AF"}, # Biru
    "Pembersihan Gulma": {"bg": "#F3E8FF", "text": "#6B21A8"}, # Ungu
    "Pemanenan": {"bg": "#FEE2E2", "text": "#991B1B"}, # Merah
    "Pemantauan": {"bg": "#F1F5F9", "text": "#475569"}  # Abu
}
